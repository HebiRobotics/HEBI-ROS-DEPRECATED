...
"""
This program allows for the Mobile IO application to work with an omnibase device on the same network
...
print('{0} | {1}'.format(group.family, group.name))
...
while (running):
	...
	if(io_b.get_int(8) !=0):	
		...
		ROS_INFO("End of Program, disconnecting from Mobile IO")
