...
int main(int argc, char **argv) {
  ...
  ros::ServiceClient add_group_client = n.serviceClient<hebi::add_group_from_names>(
    "/hebicore/add_group_from_names");
  ros::Publisher command_publisher = n.advertise<sensor_msgs::JointState>(
    "/hebicore/"+group_name+"/command", 100);
  ros::Subscriber feedback_subscriber = n.subscribe(
    "/hebicore/"+group_name+"/feedback", 100, feedback_callback);


  hebi::add_group_from_names add_group_srv;
